...
class BlenderUSDService:
    ...
    def get_current_usd(self, source=None): 
        ...
        if is_usd_loaded(): 
            ...
            bpy.ops.wm.usd_import(filepath=self.usd_file)  # Load USD in Blender

    def send_usd(self): 
        
        bpy.ops.wm.usd_export(filepath=self.usd_file)

    def save_usd_file(self): 


        

if __name__ == "__main__":
    test = BlenderUSDService("/Users/masonkirby/Desktop/my_usd_install_dir/extras/usd/tutorials/endToEnd/shot.usd")
    test.get_current_usd()
